...
import { FormSettingsSchema } from "./shared";
...
export { StoredLogicRuleSchema };

// FormStructureSchema は apps/api/src/types/domain/form.ts の FormStructure と
// フィールド構成を一致させること。フィールドの追加・削除時は両方を更新する。
// セクション情報は section_separator ブロックから実行時に派生するため、
// sections フィールドは含めない。
